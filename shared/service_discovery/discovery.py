...
class ServiceDiscovery:
    ...
    def get_service_url(self, 
                      service_name: str, 
                      strategy: str = 'random',
                      only_healthy: bool = True) -> Optional[str]:
        """
    ...
    def get_services(self, 
                   service_name: str, 
                   only_healthy: bool = True) -> List[ServiceInfo]:
        """
    ...
    def _select_random(self, services: List[ServiceInfo], _: str) -> Optional[ServiceInfo]:
        """Select a random service from the list"""
        return random.choice(services) if services else None
    
    def _select_first(self, services: List[ServiceInfo], _: str) -> Optional[ServiceInfo]:
        """Select the first service from the list"""
        return services[0] if services else None
    
    def _select_round_robin(self, services: List[ServiceInfo], service_name: str) -> Optional[ServiceInfo]:
